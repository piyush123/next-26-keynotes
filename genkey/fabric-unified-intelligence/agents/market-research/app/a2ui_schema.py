...
"""A2UI v0.8 schema and source citation examples for the market research agent.
...
# ---------------------------------------------------------------------------
# Few-shot example: A2UI Citations list output for market research agent
# ---------------------------------------------------------------------------

CITATIONS_A2UI_EXAMPLE = """
[
  { "beginRendering": { "surfaceId": "research-sources", "root": "root" } },
  { "surfaceUpdate": {
